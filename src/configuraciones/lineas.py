...
def lineas_add(request):
    ...
    if existe_error:
        db_tags = get_html_column(apps.get_model('configuraciones', 'Lineas'), 'descripcion', request, None, 'linea', 'codigo', 'descripcion', 'posicion')
    else:
        db_tags = get_html_column(apps.get_model('configuraciones', 'Lineas'), 'descripcion', None, None, 'linea', 'codigo', 'descripcion', 'posicion')
...
def lineas_modify(request, linea_id):
    ...
    # restricciones de columna
    if existe_error:
        db_tags = get_html_column(apps.get_model('configuraciones', 'Lineas'), 'descripcion', request, linea, 'linea', 'codigo', 'descripcion', 'posicion')
    else:
        db_tags = get_html_column(apps.get_model('configuraciones', 'Lineas'), 'descripcion', None, linea, 'linea', 'codigo', 'descripcion', 'posicion')
