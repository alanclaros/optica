...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Marcas',
            fields=[
                ('marca_id', models.AutoField(db_column='marca_id', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='DisenioLentes',
            fields=[
                ('disenio_lente_id', models.AutoField(db_column='disenio_lente_id', primary_key=True, serialize=False)),
                ('disenio_lente', models.CharField(default='', max_length=150)),
                ('codigo', models.CharField(default='', max_length=150)),
                ('descripcion', models.CharField(default='', max_length=250)),
                ('imagen', models.CharField(default='', max_length=250, unique=True)),
                ('imagen_thumb', models.CharField(default='', max_length=250, unique=True)),
