...
def load_data(apps, schema_editor):
    ...
    configuraciones_add = Configuraciones.objects.create(
        configuracion_id=1, cant_per_page=30, cant_productos_home=9,
        usar_fecha_servidor='si', fecha_sistema='now',
        numero_actual_venta=0,
    ...
    sucursal_add = Sucursales.objects.create(ciudad_id=cochabamba, user_perfil_id=user_perfil, status_id=status_activo, sucursal='Sucursal Central', codigo='SC-CBA', email='acc.claros@gmail.com',
                                             empresa='Optica Ideal', direccion='Av. San Martin # 147 entre Heroinas y Colombia Edif. Principito P/B', ciudad='Cochabamba - Bolivia', telefonos='4331765 - 70791680', actividad='Optica', created_at='now', updated_at='now')
    sucursal_add.save()
    # sucursal central
