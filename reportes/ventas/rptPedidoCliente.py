...
def myFirstPage(canvas, doc):
    ...
    # fecha
    canvas.drawString(posX*mm, posY*mm, RPT_FECHA)
    ...
    # cliente
    posY = posY - altoTxt
    canvas.drawString(posX*mm, posY*mm, RPT_CLIENTE)
    ...
    # total
    posY = posY - altoTxt
    canvas.drawString(posX*mm, posY*mm, RPT_TOTAL)
    ...
    if RPT_ANULADO != '':
        posY = posY - altoTxt
        canvas.drawString(posX*mm, posY*mm, RPT_ANULADO)
...
def rptPedidoCliente(buffer_pdf, usuario, pedido_id):
    ...
    RPT_CLIENTE = datos_pedido['apellidos'] + ' ' + datos_pedido['nombres'] + ', (' + datos_pedido['telefonos'] + ')'
