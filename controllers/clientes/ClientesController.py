...
class ClientesController(DefaultValues):
    ...
    def is_in_db(self, id, nuevo_valor):
        ...
        filtros['telefonos__iexact'] = nuevo_valor
    ...
    def save(self, request, type='add'):
        ...
        try:
            ...
            telefonos_txt = validate_string('telefonos', request.POST['telefonos'], remove_specials='yes', len_zero='no')
            ...
            if not self.is_in_db(id, telefonos_txt):
                # activo
                if activo == 1:
                ...
                self.error_operation = "Ya existe este telefono: " + telefonos_txt
                return False
    ...
    def save_db(self, type='add', **datos):
        ...
        if not self.is_in_db(datos['id'], datos['telefonos']):
            try:
                if type == 'add':
            ...
            self.error_operation = "Ya existe este telefono: " + datos['telefonos']
            return False

    def buscar_cliente(self, telefonos='', apellidos='', nombres=''):
