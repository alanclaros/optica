...
class DefaultValues(object):
    ...
    def __init__(self):
        ...
        self.salida_laboratorio, self._status_salida_laboratorio = int(settings.STATUS_SALIDA_LABORATORIO), None
        self.vuelta_laboratorio, self._status_vuelta_laboratorio = int(settings.STATUS_VUELTA_LABORATORIO), None
        ...
        self.perfil_vendedor = int(settings.PERFIL_VENDEDOR)
    ...
    @property
    def status_salida_laboratorio(self):
        if self._status_salida_laboratorio is None:
            self._status_salida_laboratorio = apps.get_model('status', 'Status').objects.get(pk=self.salida_laboratorio)

        return self._status_salida_laboratorio

    @property
    def status_vuelta_laboratorio(self):
        if self._status_vuelta_laboratorio is None:
            self._status_vuelta_laboratorio = apps.get_model('status', 'Status').objects.get(pk=self.vuelta_laboratorio)

        return self._status_vuelta_laboratorio
